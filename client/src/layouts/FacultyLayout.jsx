...
const FacultyLayout = ({ children, headerTitle, headerSubtitle }) => {
  ...
  const routeTitle = useMemo(() => {
    const map = {
      ...
      "/faculty/weekly-timetable": "Weekly Timetable",
  ...
  return (
    <div className="h-screen flex bg-gray-100">
      <FacultySidebar isOpen={isSidebarOpen} onClose={closeSidebar} />
